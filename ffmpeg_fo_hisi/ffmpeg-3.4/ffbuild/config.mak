...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--disable-yasm --disable-ffplay --disable-ffprobe --disable-ffserver --disable-debug --disable-avdevice --disable-devices --disable-zlib --disable-bzlib --disable-encoders --enable-ffmpeg --enable-static --enable-gpl --enable-small --target-os=linux --arch=arm --enable-cross-compile --cross-prefix=arm-himix100-linux- --cc=arm-himix100-linux-gcc --prefix=./out
prefix=./out
...
CC_IDENT=gcc 6.3.0 (Heterogeneous Compiler&Codesign V100R002C00B003)
ARCH=arm
INTRINSICS=none
...
DOXYGEN=doxygen
LDFLAGS=  -march=armv5t -Wl,--as-needed -Wl,-z,noexecstack -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
LDEXEFLAGS=
LDLIBFLAGS=
...
EXTRALIBS=-lm -ldl -pthread -pthread 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
