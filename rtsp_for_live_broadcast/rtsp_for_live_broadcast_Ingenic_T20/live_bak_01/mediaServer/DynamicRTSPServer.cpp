...
static ServerMediaSession* createNewSMS(UsageEnvironment& env,
  ...
  if (strcmp(extension, ".aac") == 0) {
    ...
    NEW_SMS("H.265 Video");
    OutPacketBuffer::maxSize = 300000;//100000; // allow for some possibly large H.265 frames
...
//#define INTERLEAVE_ADUS 1
    ...
    OutPacketBuffer::maxSize = 300000;//100000; // allow for some possibly large VP8 or VP9 frames
