...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-shared --prefix=/usr/local/ffmpeg --enable-libmp3lame --enable-gpl --enable-version3 --enable-nonfree --enable-pthreads --enable-postproc --enable-ffserver --enable-ffplay --enable-libx264 --enable-libxvid --disable-x86asm
...
EXTRALIBS=-lva -lva-x11 -lX11 -lva -lva-drm -lva -lxcb -lxcb-shm -lxcb-xfixes -lxcb-shape -lxvidcore -lx264 -lmp3lame -lm -ldl -llzma -lz -pthread -pthread 
COMPAT_OBJS=
INSTALL=install
LIBTARGET=
